...
<FORM name="form1" action="registrationconf.asp" method="post" onsubmit="return check();">
	...
	<table border="0" width="100%" id="table6" cellpadding="2">
		...
		<tr>
			...
			<td align="left" style="WIDTH: 174px">
                &nbsp;Region Code:</td>
			<td style="WIDTH: 371px" align="left">&nbsp;<FONT size="1" color="#626258" face="Verdana, Arial, Helvetica, sans-serif"><INPUT name="regioncode" size="8" maxlength="2"  class="textb1"
                 ></FONT></td>
			<td width="89">&nbsp;</td>
		</tr>
		<tr>
			...
			<td align="left" style="WIDTH: 174px">
                &nbsp;TLC Code:</td>
			<td style="WIDTH: 371px" align="left">&nbsp;<FONT size="1" color="#626258" face="Verdana, Arial, Helvetica, sans-serif"><INPUT name="tlccode" size="8" maxlength="4"  class="textb1"
                 ></FONT></td>
			<td width="89">&nbsp;</td>
		</tr>
		<tr>
			...
			<td align="left" style="WIDTH: 174px">
                &nbsp;Stream:</td>
			<td style="WIDTH: 371px" align="left"><input type="radio" value="P" name="stream_p"  >Programming&nbsp;
			<input type="radio" value="M" checked name="stream_m"> Multimedia</td>
			<td width="89">&nbsp;</td>
		</tr>
		<tr>
			<td width="16">&nbsp;</td>
